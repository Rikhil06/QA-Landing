  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/8 text-white/50 hover:text-white hover:border-white/20 hover:bg-white/8 transition-all text-xs"
